...
write.csv(SA_yld_coef_kill_40 , "W:/Economic impact of weeds round 2/fallow_weeds_yld_loss/yld_loss_coef_SA_clay_inital_water20_sow_1stJan_kill_40days.csv" )
