...
SA_sites <- SA_sites %>% 
  ...
  filter(soil == "Duplex" ) %>% # I tried with other soils
...
write.csv(SA_yld_coef_kill_40 , "W:/Economic impact of weeds round 2/fallow_weeds_yld_loss/NO3_replacement_SA_Duplex_inital_water20_sow_1stJan_kill_40days.csv" )
