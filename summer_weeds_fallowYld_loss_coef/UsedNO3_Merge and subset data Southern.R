...
SA_sites <- SA_sites %>% 
  ...
  filter(soil == "Loam" ) %>% # I tried with other soils
...
write.csv(SA_yld_coef_kill_40 , "W:/Economic impact of weeds round 2/fallow_weeds_yld_loss/NO3_replacement_SA_Loam_inital_water20_sow_1stJan_kill_40days.csv" )
