...
##----------------------------------------------------------------------------##
#### count the number of weed spec per AEZ #### 
...
write.csv(top4weeds, 
          "W:/Economic impact of weeds round 2/HR/Jackie_working/Weed_list/2020_data/top4weeds_FALLOW_2020.csv")
...
write.csv(Final_list_AEZ, "W:/Economic impact of weeds round 2/HR/Jackie_working/Weed_list/2020_data/Final_rank1_2_3_4_weed_AEZ_FALLOW_2020.csv")
